...
(async () => {
    const url = "https://www.goal.com/id/jadwal/2025-04-12";
...
async function crawlGaol(url, filename, tanggal_match, jsonArray) {
    ...
    const teams = [mancity, arsenal, "Everton", "Brighton & Hove Albion", "Galatasaray", "Real Sociedad", "Getafe"];
    const league = [inggris, spanyol, "Turki - Super Lig"];
    let items = [];
    let tanggal;
    if (tanggal_match)
