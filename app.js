...
(async () => {
    const url = "https://www.goal.com/id/jadwal/2025-11-27";
...
async function crawlGaol(url, filename, tanggal_match, jsonArray) {
    ...
    const teams = ["Kairat Almaty", "Monaco", "Arsenal", "Inter", "Atalanta", "Liverpool", "Real Madrid", "Tottenham Hotspur", "Club Brugge"];
    const league = ["International - Champions League"];
    let items = [];
    let tanggal;
    if (tanggal_match)
