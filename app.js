...
(async () => {
    const url = "https://www.goal.com/id/jadwal/2025-04-02";
...
async function crawlGaol(url, filename, tanggal_match, jsonArray) {
    ...
    const teams = [arsenal, "Wolverhampton Wanderers", manutd, realmadrid, "Arminia Bielefeld", "Paris Saint-Germain"];
    const league = [inggris, "Italia - Coppa Italia", "Jerman - DFB-Pokal", "Prancis - Coupe de France"];
    let items = [];
    let tanggal;
    if (tanggal_match)
